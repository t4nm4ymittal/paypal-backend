...
public class WalletService {
    ...
    public WalletResponse createWallet(CreateWalletRequest request) {
        ...
        System.out.println("💰 created request received: userId=" + request.getUserId() +
    ...
    public WalletResponse getWallet(Long userId) {
        System.out.println("🔍 Fetching wallet for userId: " + userId);
        Wallet wallet = walletRepository.findByUserIdAndCurrency(userId, "INR")
                .orElseThrow(() -> new NotFoundException("Wallet not found for user: " + userId));

        System.out.println("💰 Found wallet - Balance: " + wallet.getBalance() +
